...
* Bellman-ford detect negative cycles and determine where they occur but fails to find shortest path if there is negative cycle.
...
& Works with directed graph without negative cycle and with only those undirected graph which do not have negative weights. If undirected graph has a negative weight then it act as negative cycle (-ve self loop).
*/
